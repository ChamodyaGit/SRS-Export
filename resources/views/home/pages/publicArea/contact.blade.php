...
<main>
                ...
                <div class="col-lg-6">
                    <div class="contact-info bg-gray pt-56 pb-md-46 mb-sm-24">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#" class="social-icon-colors fs-4 me-2"><i class="fa fa-facebook"></i></a>
                        ...
                        <div class="working-time">
                            <h3>Working hours</h3>
                            <p><span>Monday – Saturday:</span>8 AM – 10 PM</p>
                            <p class="sunday-time"><span>Sunday:</span>8 AM – 1 PM</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="map-area-wrapper">
        ...
        {{-- <div id="map_content" data-lat="6.5202030" data-lng="79.9932100" data-zoom="10" data-maptitle="Hastech"
            data-mapaddress="Maggona, Sri Lanka">
        </div> --}}
