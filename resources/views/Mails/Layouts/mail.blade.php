...
<body>
    <div
        ...
        <diV
            style="padding-left: 30px; padding-right: 30px;padding-top: 30px;padding-bottom: 30px;background-color:white;border-radius: 15px;">
            @include('Mails.Includes.nav')
            @yield('content')
        </div>
        <div style="padding-top: 10px">
            @include('Mails.Includes.footerMail')
        </div>
    </div>
